    ...
    <main className="h-screen w-screen bg-blue-400 ">
      ...
      <section className="flex flex-col items-center w-full mt-8 justify-evenly">
        ...
        <article className="flex mt-4 justify-evenly">
          ...
          />
          <button className="w-22 border-2 border-gray-400 rounded-lg bg-gray-100 ml-2 p-1.5 hover:bg-gray-400">
            Change Password
          </button>
        </article>
        <article className="flex mt-4 justify-evenly">
          ...
          <input
            ...
            className="border-2 border-red-500 w-22 max-w-xs rounded-md"
          />
          <button className="w-22 border-2 border-gray-400 rounded-lg bg-gray-100 ml-2 pl-6 pr-6 hover:bg-gray-400">
            Change Email
          </button>
        </article>
      </section>
